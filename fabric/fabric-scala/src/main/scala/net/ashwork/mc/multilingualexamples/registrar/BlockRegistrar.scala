...
object BlockRegistrar {
     ...
     */
    private def registerFlattenableWithSimpleItem[T <: Block](name: String, obj: T, flattened: BlockState, itemProperties: () => Item.Properties): T = {
        val block = registerBlockWithSimpleItem(name, obj, itemProperties)
