...
public class DrippingAshParticle extends TextureSheetParticle {
     ...
     */
    public DrippingAshParticle(ClientLevel level, double xOriginal, double yOriginal, double zOriginal, double xVelocity, double yVelocity, double zVelocity, SpriteSet sprites) {
    ...
    public static class DrippingAshParticleProvider implements ParticleProvider<SimpleParticleType> {
        ...
        @Nullable
        @Override
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double xOriginal, double yOriginal, double zOriginal, double xVelocity, double yVelocity, double zVelocity) {
