...
class CollageModel(root: ModelPart, renderType: (ResourceLocation) -> RenderType):
	...
	*/
     ...
     */
    fun copyAndSet(original: HumanoidModel<*>, slot: EquipmentSlot) {
        /*
    ...
    override fun setupAnim(entity: LivingEntity, animationPosition: Float, animationSpeed: Float, bob: Float, yHeadRot: Float, xHeadRot: Float) {}
    ...
    override fun headParts(): MutableIterable<ModelPart> {
		 ...
		 */
        return mutableListOf(this.head)
    }
