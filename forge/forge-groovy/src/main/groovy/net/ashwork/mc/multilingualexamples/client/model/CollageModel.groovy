...
class CollageModel extends AgeableListModel<LivingEntity> {
     ...
     */
    CollageModel(ModelPart root, Function<ResourceLocation, RenderType> renderType) {
     ...
     */
    static MeshDefinition createMesh(CubeDeformation deformation, float yOffset) {
     ...
     */
    void copyAndSet(HumanoidModel<? extends LivingEntity> original, EquipmentSlot slot) {
        /*
    ...
    @Override
    void setupAnim(LivingEntity entity, float animationPosition, float animationSpeed, float bob, float yHeadRot, float xHeadRot) {}
