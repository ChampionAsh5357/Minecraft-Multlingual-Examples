...
public final class ItemRegistrar {
    ...
    public static final RegistryObject<Item> COLLAGE_HELMET = Registrars.ITEMS.register("collage_helmet", () -> new CustomArmorModelItem(ExampleArmorMaterials.COLLAGE, EquipmentSlot.HEAD, new Item.Properties()));
    public static final RegistryObject<Item> COLLAGE_CHESTPLATE = Registrars.ITEMS.register("collage_chestplate", () -> new CustomArmorModelItem(ExampleArmorMaterials.COLLAGE, EquipmentSlot.CHEST, new Item.Properties()));
    public static final RegistryObject<Item> COLLAGE_LEGGINGS = Registrars.ITEMS.register("collage_leggings", () -> new CustomArmorModelItem(ExampleArmorMaterials.COLLAGE, EquipmentSlot.LEGS, new Item.Properties()));
    public static final RegistryObject<Item> COLLAGE_BOOTS = Registrars.ITEMS.register("collage_boots", () -> new CustomArmorModelItem(ExampleArmorMaterials.COLLAGE, EquipmentSlot.FEET, new Item.Properties()));
